...
export function FeedbackProgressSlider({
  ...
  const sliderPosition =
    getSliderPosition(boundedValue);
    ...
    >
      <div className="relative h-[30px]">
        ...
        <input
          ...
          aria-label={label}
          className="absolute inset-0 h-full w-full cursor-pointer appearance-none opacity-0 disabled:cursor-not-allowed [&::-webkit-slider-thumb]:h-[25px] [&::-webkit-slider-thumb]:w-9 [&::-webkit-slider-thumb]:appearance-none [&::-moz-range-thumb]:h-[25px] [&::-moz-range-thumb]:w-9 [&::-moz-range-thumb]:border-0"
        />
      </div>
