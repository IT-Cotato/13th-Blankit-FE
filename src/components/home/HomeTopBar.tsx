...
import clearIcon from "@/assets/icons/x-black-600.svg";
      ...
      <div className="flex w-full items-center justify-between">
        ...
        <div className="relative flex items-center gap-3">
          ...
          {showRegistrationHint && isHintVisible && (
            <div
              role="status"
              className="absolute right-8 top-[60px] z-10 flex h-[42px] w-max items-center gap-2 rounded-[8px] bg-black-700 px-4 py-3"
            >
              <div className="absolute -top-2 right-[26px] h-0 w-0 border-x-[8px] border-b-[8px] border-x-transparent border-b-black-700" />

              <span className="text-[12px] font-medium leading-[18px] text-black-400">
                과업을 등록해보세요
              </span>
