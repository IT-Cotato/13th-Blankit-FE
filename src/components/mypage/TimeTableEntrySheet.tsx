            ...
            {entries.map((entry, index) => (
              ...
              >
                <button
                  ...
                  onClick={() =>
                    setWheelRequest({ mode: "edit-day", index, entry })
                  }
                ...
                >
                  <span>{DAY_LABELS[entry.dayIndex]}</span>
                  <img
                ...
                <button
                  type="button"
                  onClick={() =>
                    setWheelRequest({ mode: "edit-time", index, entry })
                  }
                ...
                >
                  <span className="flex items-center">
                    <span>{formatSlot(entry.startSlot, startHour)}</span>
                    <img
                      src="/mypage/Rectangle.svg"
                      alt="부터"
                      className="mx-2 h-0.5 w-2 shrink-0"
                    />
                    <span>{formatSlot(entry.endSlot + 1, startHour)}</span>
                  </span>
                  <img
                    src="/mypage/wheel.svg"
                    alt=""
